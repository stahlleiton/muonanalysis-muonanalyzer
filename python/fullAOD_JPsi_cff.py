...
muon = cms.EDAnalyzer('MuonFullAODAnalyzer',
           ...
           trgDRwindow = cms.double(0.1), # dr window hlt L3 mu/offline
           trgRelDPtwindow = cms.double(10.0), # rel dpt window hlt L3 mu/offline
           trgL2DRwindow = cms.double(0.3), # dr window hlt L2 mu/offline
           trgL2RelDPtwindow = cms.double(10.0), # rel dpt window hlt L2 mu/offline
           trgL1DRwindow = cms.double(0.3), # dr window hlt L1 mu/offline
           trgL1DEtawindow = cms.double(0.2), # deta window hlt L1 mu/offline
